...
async def bot_(client, message):
    buttons_ = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Source", url="https://github.com/flaviotn595/GitAlerta"),
                    InlineKeyboardButton("Dev", url="ttps://t.me/Sora_net"),
                ],
                [
                    InlineKeyboardButton("✨ Suporte", url="https://t.me/Sora_net")
                ],
            ]
        )
...
async def run():
    logging.info("[Iniciando] [SoraGit] - Bot & Server")
    await gitbot.start()
